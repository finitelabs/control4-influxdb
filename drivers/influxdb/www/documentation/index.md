...
4. Use the **Select Variable** (VARIABLE_SELECTOR) property to browse and pick a
   Control4 system variable (any device or room variable).
5. Set **Add Variable As** to **Field** or **Tag** (see below), then click **Add
   Variable** — the variable is immediately associated with the measurement.

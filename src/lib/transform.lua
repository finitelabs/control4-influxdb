...
--- @param rawValue any The raw variable value
--- @return any result The transformed value (or rawValue on error)
--- @return string|nil err Error message if transform failed
function Transform.eval(expression, rawValue)
  ...
  -- names (value, device_name, etc.) from the sandbox environment.
